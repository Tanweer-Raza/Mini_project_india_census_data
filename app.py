...
country_df = pd.read_csv('state_wise_india_census.csv')

list_of_states = list(df['State'].unique())
list_of_states.insert(0,'Overall India')

st.sidebar.title('India Census 2011 (- Project by T.Raza)')
...
if plot:
    ...
    if selected_state == 'Overall India':
        # plot for India
        fig = px.scatter_mapbox(country_df, lat="Latitude", lon="Longitude", size=primary, color=secondary, zoom=4, size_max=35,
